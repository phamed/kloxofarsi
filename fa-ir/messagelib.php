...
$__emessage['token_not_match'] = "رمز مطابقت ندارد. امکان ورود به سیستم نیست . بازگشت به صفحه <a href='/login/'>ورود</a> page";
//$__emessage['blocked'] = "Your address is blocked. Wait 10 minutes to login again.";
$__emessage['blocked'] = "آدرس IP شما مسدود شده است.";
$__emessage['blocked_remaining'] = "صبر کنید تا زمانی که";
$__emessage['no_server'] = "امکان اتصال به سرور وجود ندارد.";
$__emessage['set_emailid'] = "لطفا EmailId خود را وارد کنید ";
...
$__emessage['login_error'] = "ورود ناموفق";
...
$__emessage['e_password'] = "کلمه عبور وارد شده اشتباه است";
$__emessage['is_demo'] = "[%s] در حالت دمو غیرفعال است.";
$__emessage['user_create'] = "کاربر [%s] نمیتواند ساخته شود . لطفا با نام دیگری تست کنید";
...
$__emessage['password_sent'] = "رمز عبور ریست و با موفقیت ارسال شد.";
...
$__emessage['user_exists'] = "کاربر [%s] از قبل وجود دارد.";
...
$__information['login_pre'] = "<p>به نارا خوش آمدید</p>".
